...
//            var token = new ClientTokenEntity
//            {
//                Token = "good.token",
...
//            //Act
//            _mockClientRepository.Setup(repo => repo.Get()).
...
//            _mockClientRepository.Setup(repo => repo.Get()).Throws(new AuthenticationException());
...
//            var userToken = new ClientTokenEntity
//            {

//            };

//            _mockUserTokenRepository
//                .Setup(repo => repo.UpdateAsync(It.IsAny<ClientTokenEntity>()))
//                .ReturnsAsync(userToken);

//            _mockClientRepository.Setup(user => user.Get()).
//                Returns(users.AsQueryable().BuildMockDbSet().Object);

//            var actual = await _testing.AuthenticateAsync(username, password);

//            _mockUserTokenRepository.Verify(token =>
//                    token.UpdateAsync(It.IsAny<ClientTokenEntity>()),
//                    Times.Once);
//        }
...
//            var expiredUserToken = new ClientTokenEntity
//            {
//                UserId = 1,
//                Token = "expired.token",
...
//                    UserName = username,
//                    Password =  ProtectionHelper.EncryptValue(username + password),
//                    ClientTokenEntity = expiredUserToken
//                }
...
//            _mockClientRepository.Setup(repo => repo.Get()).Returns(userList);
